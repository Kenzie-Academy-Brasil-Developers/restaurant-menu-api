import { TRestaurant, TRestaurantReturn } from "../../schemas/restaurant.schema";

export const restaurantDefaultExpects = (restaurant: TRestaurantReturn, restaurantExpect: TRestaurant) => {
